...
| Transactions         |                                  
| -------------- | 
| + str id_transaction <br> + str id_user <br> + str id_external <br> + str id_site <br> + str id_site_organization <br> + str id_site_organization_type <br> + str id_account <br> + str id_account_type <br> + str id_currency <br> + int is_disable <br> + str description <br> + float amount <br> + str currency <br> + list attachments <br> + dict extra <br>  + str reference <br> + str dt_transaction <br> + str dt_refresh   |
