...
class Attachment(main.Paybook):
    ...
    def get(session=None, id_user=None, options=None, id_attachment=None, extra=None):
        ...
        if id_attachment:  # Attachment content
            ...
            attachment_data = Attachment.__call__(
                endpoint=id_attachment, method='get', params=params)
            return attachment_data
        else:
            attachment_jsons = Attachment.__call__(
                endpoint='attachments', method='get', params=params)
        attachments = []
    ...
    def get_count(session=None, id_user=None, options=None):
        ...
        attachments_count_json = Attachment.__call__(
            endpoint='attachments/count', method='get', params=params)
