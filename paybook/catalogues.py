...
class Catalogues(main.Paybook):
    ...
    def get_account_types(session=None, id_user=None, options=None):
        ...
        account_type_jsons = Catalogues.__call__(
            endpoint='catalogues/account_types', method='get', params=params)
        account_types = []
    ...
    def get_attachment_types(session=None, id_user=None, options=None):
        ...
        attachment_type_jsons = Catalogues.__call__(
            endpoint='catalogues/attachment_types', method='get', params=params)
        attachment_types = []
    ...
    def get_countries(session=None, id_user=None, options=None):
        ...
        country_jsons = Catalogues.__call__(
            endpoint='catalogues/countries', method='get', params=params)
        countries = []
    ...
    def get_sites(session=None, id_user=None, options=None, is_test=False):
        ...
        site_jsons = Catalogues.__call__(
            endpoint='catalogues/sites', method='get', params=params)
        sites = []
    ...
    def get_site_organizations(session=None, id_user=None, options=None, is_test=False):
        ...
        if is_test is True:
            params['is_test'] = is_test
        site_organization_jsons = Catalogues.__call__(
            endpoint='catalogues/site_organizations', method='get', params=params)
        site_organizations = []
...
class Site():
    ...
    def __init__(self, site_json):
        ...
        for credential_structure_json in site_json['credentials']:
            credentials_structure = Credentials_structure(
                credential_structure_json)
