...
class Session(main.Paybook):
    ...
    def __init__(self, user=None, token=None):
        ...
        if token is not None:
            ...
            session_json = Session.__call__(
                endpoint='sessions', method='post', data=data)
    ...
    def verify(self):
        ...
        Session.__call__(endpoint='sessions/' + self.token +
                         '/verify', method='get')  # If not, raise Error
        return True
    ...
    def delete(token=None):
        ...
        Session.__call__(endpoint='sessions/' + token + '',
                         method='delete')  # If error, raise Error
        return True
