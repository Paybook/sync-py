...
class Credentials(main.Paybook):
    ...
    # If it already exists it retrieves the existing one
    def __init__(self, session=None, id_user=None, id_site=None, credentials=None, credentials_json=None):
        Credentials.log('\n')
        ...
        if credentials_json is None:
            ...
            credentials_json = Credentials.__call__(
                endpoint='credentials', method='post', data=dumps(data))
        ...
        self.id_site_organization = credentials_json[
            'id_site_organization'] if 'id_site_organization' in credentials_json else None
        self.id_site_organization_type = credentials_json[
            'id_site_organization_type'] if 'id_site_organization_type' in credentials_json else None
    ...
    def delete(session=None, id_user=None, id_credential=None):
        ...
        delete_response = Credentials.__call__(
            endpoint='credentials/'+id_credential, method='delete', params=params)
        return True
    ...
    def get(session=None, id_user=None):
        ...
        credentials_jsons = Credentials.__call__(
            endpoint='credentials', method='get', params=params)
        credentials_list = []
    ...
    def get_status(self, session=None, id_user=None):
        ...
        if self.id_site is not None:
            ...
            status = Credentials.__call__(method='get', data=dumps(
                data), headers=headers, url=self.status)
    ...
    def set_twofa(self, session=None, id_user=None, twofa_value=None):
        ...
        if self.id_site:
            ...
            Credentials.__call__(
                method='post', data=dumps(data), url=self.twofa)
            return True
