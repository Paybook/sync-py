...
class User(main.Paybook):
    ...
    def __init__(self, name=None, id_user=None, id_external=None, user_json=None):
        User.log('\n')
        ...
        if user_json is None:
            if id_user is None and name is not None:  # New user
                ...
                user_json = User.__call__(
                    endpoint='users', method='post', data=data)
    ...
    def delete(id_user=None):
        ...
        delete_response = User.__call__(
            endpoint='users/'+id_user, method='delete', params=params)
        return True
    ...
    def get(options=None):
        ...
        user_jsons = User.__call__(
            endpoint='users', method='get', params=params)
        users = []
